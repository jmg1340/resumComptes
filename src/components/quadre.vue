      ...
      <template v-slot:top-right>
        <div class="row q-gutter-md">
          ...
          <q-select
            ...
            outlined
            label-color="orange"
            v-model="compteSeleccionat"
            :options="getComptes"
            label="Seleccionar compte"
          >
      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          <q-td
            key="concepte"
            :props="props"
            @click="veureMoviments(props.row.concepte)"
          >
            {{ props.row.concepte }}
          </q-td>
          ...
          <q-td
            key="totalConcepte"
            :props="props"
            :class="{ colorImport: props.row.totalConcepte < 0 }"
          >
...
export default {
  ...
  data() {
    return {
      compteSeleccionat: {
        label: "Compte Carlos & Mª Dolors",
        value: "ES89 2100 1085 9001 0053 9597"
      },
      anySeleccionat: null,
  ...
  methods: {
    veureMoviments(concepte) {
      ...
      this.arrMoviments = this.$store.getters["modulIG/getMoviments"](
        this.compteSeleccionat.value,
        this.anySeleccionat,
        concepte
      );
  ...
  computed: {
    ...
    getAnys: function() {
      if (this.compteSeleccionat === null) {
        ...
        return this.$store.getters["modulIG/getAnys"](
          this.compteSeleccionat.value
        );
      }
    },
    ...
    getQuadre: function() {
      ...
      if (
        this.compteSeleccionat.value === null &&
        this.anySeleccionat === null
      ) {
        return [];
      } else {
        return this.$store.getters["modulIG/getQuadreDades"](
          this.compteSeleccionat.value,
          this.anySeleccionat
        );
      }
